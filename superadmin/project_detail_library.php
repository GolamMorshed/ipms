					...
					<div  class="row">
						...
						<div id="project" class="tabcontent">
							<div class="w3-bar w3-black">
								...
								<button class="allButton tablink tabs_blue" onclick="location.href='../superadmin/project_detail_library.php';">Library</button>
								<button style="margin-left: 20vw;" onclick="" class="allButton">Upload File</button>
							</div>
