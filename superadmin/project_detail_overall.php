					...
					<div  class="row">
						...
						<div id="project" class="tabcontent">
							<div class="w3-bar w3-black">
								<button class="allButton tablink tabs_blue" onclick="location.href='../superadmin/project_detail_overall.php';">Overall</button>
								<button class="allButton tablink" onclick="location.href='../superadmin/project_detail_consultant.php';">Consultant</button>
							...
							<div id="Consultant" class="tabs" style="display:none">
								<table id="" class="dataTable" style="">
									<thead >
										<tr class="header">
