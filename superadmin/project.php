		...
		<body onload="populateDevDropdown()">
			<div id="allSection" class="allSection">
				...
				<div id="allContent" class="allContent" style="padding:50px 70px 100px 70px;">
					<div  class="row">
						<h1 class='dashboard'>
							<p class="history"></p>Project
							<div class="btn-right"><button onclick="" class="allButton">Create New Project</button></div>
							<div class="btn-right"><button onclick="" class="allButton">View Lastest Log</button></div>
						</h1>
								...
								<table id="" class="dataTable" style="">
									...
									<tbody id="">
										<tr>	
											<td width="">01</td> 
											<td width="">ABC</td>
											<td><a href="../superadmin/project_detail_overall.php"><img src="../images/msg.png" class="smicon"></a><a href="" onclick=""><img src="../images/trash.png" class="smicon"></a>
											</td>
										</tr>
									</tbody>
								</table>
