						...
						<div id="proprietor" class="tabcontent">
							<form method="POST"> 
								<table id="" class="dataTable ">
									<thead>
										<tr class="header">
											<td colspan="3">Key Approved Plan Reference No.</td> 
										</tr>
									</thead>
									<tbody id="">
										<tr>	
										...
										<tr>	
											<td>
												<div class="flex-container">
													<div class="form-register">
														<fieldset id="" class="lbl">
															<legend id="">Approved Date</legend>
															<select id="" class="allInput" name="">
																<option disabled selected value=""></option>
															</select>
														</fieldset>
											...
											<td>
												<div class="flex-container">
													<div class="form-register">
														<fieldset id="" class="lbl">
															<legend id="">Reminder Period</legend>
															<select id="" class="allInput" name="">
																<option disabled selected value=""></option>
															</select>
														</fieldset>
													...
													<div class="form-register">
														<fieldset id="" class="lbl">
															<legend id="">Reminder Date</legend>
											...
											<td>
											<div class="flex-container">
											<button onclick="" class="allButton">Add Plan</button>
											</div>
											</td>
											</tr>
