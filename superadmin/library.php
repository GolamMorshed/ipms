							...
							<form method="POST">
								<table id="" class="dataTable" style="">
									<thead >
										<tr class="header">
											<td width="">Module</td> 
											<td width="">Module Item Name</td> 
											<td width="">File</td>
											<td width="">Type</td>
											<td width="">Display Name</td>
											<td width="">Date Uploaded</td>
											<td width="">Action</td>
										</tr>
									</thead>
									<tbody id="">
										<tr>	
											...
											<td width="">Type</td>
											<td width="">Jon</td>
											<td width="">24/09/2020</td>
											<td><a href="" onclick=""><img src="../images/msg.png" class="smicon"></a>
											</td>
										</tr>
										<tr>	
											<td width="">2</td> 
