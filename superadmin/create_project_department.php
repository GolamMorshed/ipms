				...
				<div id="allContent" class="allContent" style="padding:50px 70px 100px 70px;">
					<div  class="row">
						...
						<div id="proprietor" class="tabcontent">
							<form method="POST"> 
								<table id="" class="dataTable" style="width:25%; float:left; min-height:260px;margin-right:2%;">
									<thead>
										<tr class="header">
											<td width="">Development Component</td> 
										</tr>
									</thead>
									<tbody id="">
										<tr>	
												...
												<div class="flex-container">
													<div class="form-register" >
														<fieldset id="" class="lbl">
															<legend id="">Conponenet Type</legend>
								...
								<table id="" class="dataTable " style="width:67%; min-height:260px;">
									<thead>
										<tr class="header">
											<td colspan="2"></td> 
										</tr>
