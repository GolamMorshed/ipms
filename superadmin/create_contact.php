		...
		<body onload="populateDevDropdown()">
			<div id="allSection" class="allSection">
				...
				<div id="allContent" class="allContent" style="padding:50px 70px 100px 70px;">
					<div  class="row">
						<h1 class='dashboard'>
							<p class="history"></p>Create new Contact
						</h1>
										...
										<tr>	
											<td>
												<div class="flex-container">
													...
													<div class="form-register">
														<fieldset id="" class="lbl">
															<legend id="">NRIC</legend>
															<input id="" onfocus="" autocomplete="" type="text" name="" class="allInput" required>
														</fieldset>
													</div>
													<div class="form-register">
														<fieldset id="" class="lbl">
															<legend id="">Race</legend>
												...
												<div class="flex-container">
													...
													<div class="form-register">
														<fieldset id="" class="lbl">
															...
															<input id="" onfocus="" autocomplete="" type="text" name="" class="allInput medium" required>
														</fieldset>
													</div>
												</div>
											</td>
										...
										<tr>	
											<td>
												<div class="flex-container">
													<div class="form-register">
														<fieldset id="" class="lbl">
															<legend id="">Remark</legend>
															<input id="" onfocus="" autocomplete="" type="text" name="" class="allInput long" required>
														</fieldset>
													</div>
												</div>
											</td>
