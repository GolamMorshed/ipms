	...
	<body>
		<div id="allSection" class="allSection">
			...
			<div id="allContent" class="allContent">
				<div class="searchBox">
					<h1 class='dashboard'><p class="history"></p>Company</h1>
				...
				<?php if($perm['registration'] == "rw" || $perm['registration'] == "w") { ?>
					<div class="buttons-row">
						<form class="move" action="reg_development_one.php">
							<input autocomplete="new-password" type="submit" class="allButton" value="Create New Company" required>
						</form>
						<!-- <form method="POST">
				...
				<div id="developments" class="tabcontent">
					...
					<table id="dataTable" class="dataTable">
						<thead>
							<tr class="header">
								<td><a href="#" onclick="sortTable('dataTable', 0, 'T')" class="arrow">Name of Business<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
								<td><a href='#' onclick="sortTable('dataTable', 1, 'T')" class="arrow">Company Name<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
								<td><a href='#' onclick="sortTable('dataTable', 2, 'N')" class="arrow">Company No<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
								<td><a href='#' onclick="sortTable('dataTable', 3, 'T')" class="arrow">Priciple Name<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
								<td><a href='#' onclick="sortTable('dataTable', 4, 'N')" class="arrow">Registered Person No<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
								<td><a href='#' onclick="sortTable('dataTable', 5, 'T')" class="arrow">Address<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
								<td><a href='#' onclick="sortTable('dataTable', 6, 'N')" class="arrow">Phone<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
								<td><a href='#' onclick="sortTable('dataTable', 7, 'N')" class="arrow">Fax<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
								<td><a href='#' onclick="sortTable('dataTable', 8, 'T')" class="arrow">Email<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
								<td><a href='#' onclick="sortTable('dataTable', 9, 'T')" class="arrow">Banker<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
								<td><a href='#' onclick="sortTable('dataTable', 10, 'N')" class="arrow">Bank A/C<div class="sortTriangle">&#x25BC;&#x25B2;</div></a></td>
